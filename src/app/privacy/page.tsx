  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '64px 24px' }}>
      ...
      <div style={SECTION}>
        ...
        <ul style={UL}>
          <li>معالجة طلباتك وتجهيز المنتجات وشحنها إلى عنوان التوصيل الذي تزوّدنا به.</li>
          <li>التواصل معك بشأن حالة طلبك أو موعد التوصيل أو أي مشكلة تتعلق بالمنتج.</li>
      ...
      <div style={SECTION}>
        ...
        <ul style={UL}>
          <li><strong style={{ color: '#111827' }}>شركات التوصيل:</strong> نُشارك اسمك وعنوانك ورقم هاتفك فقط مع شركة التوصيل لإيصال طلبك إليك.</li>
