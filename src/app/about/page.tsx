  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '64px 24px' }}>
        <h1 style={{ fontSize: 40, fontWeight: 700, color: '#f5f5f4', marginBottom: 24, letterSpacing: '-0.02em' }}>
          من نحن
        </h1>

        <p style={{ fontSize: 18, color: '#a1a1a6', lineHeight: 1.8, marginBottom: 32 }}>
          <strong style={{ color: '#f5f5f4' }}>SoftoDev</strong> هو متجر عراقي 100% متخصص في بيع الاشتراكات الرقمية الأصلية للسوق العراقي.
          تأسسنا في بغداد عام 2026 بهدف واضح: إيصال أفضل الأدوات الرقمية العالمية للمستخدم العراقي بأسعار محلية وبدون أي تعقيدات.
        </p>

        <h2 style={{ fontSize: 28, fontWeight: 600, color: '#f5f5f4', margin: '48px 0 16px', letterSpacing: '-0.01em' }}>رؤيتنا</h2>
        <p style={{ color: '#a1a1a6', lineHeight: 1.8, marginBottom: 32 }}>
        ...
        {/* ── Statistics ── */}
        <h2 style={{ fontSize: 28, fontWeight: 600, color: '#f5f5f4', margin: '48px 0 16px', letterSpacing: '-0.01em' }}>SoftoDev بالأرقام</h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 16, marginBottom: 48 }}>
          {[
            ...
            <div key={stat.label} style={{ background: '#17171a', border: '1px solid #2a2a30', borderRadius: 8, padding: '24px 16px', textAlign: 'center' }}>
              <div style={{ fontSize: 36, fontWeight: 700, color: '#ff6a2b', letterSpacing: '-0.02em' }}>{stat.value}</div>
              <div style={{ fontSize: 13, color: '#6b6b70', marginTop: 8 }}>{stat.label}</div>
            </div>
          ))}
        </div>

        <h2 style={{ fontSize: 28, fontWeight: 600, color: '#f5f5f4', margin: '48px 0 16px', letterSpacing: '-0.01em' }}>لماذا SoftoDev؟</h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 16, marginBottom: 32 }}>
          {[
            ...
            <div key={item.text} style={{ background: '#17171a', border: '1px solid #2a2a30', borderRadius: 8, padding: '16px 20px', display: 'flex', gap: 12, alignItems: 'center', color: '#a1a1a6', fontSize: 14 }}>
        ...
        <h2 style={{ fontSize: 28, fontWeight: 600, color: '#f5f5f4', margin: '48px 0 16px', letterSpacing: '-0.01em' }}>قصتنا</h2>
        <p style={{ color: '#a1a1a6', lineHeight: 1.8, marginBottom: 16 }}>
        ...
        <p style={{ color: '#a1a1a6', lineHeight: 1.8, marginBottom: 48 }}>
        ...
        <div style={{ background: 'rgba(255,106,43,0.08)', border: '1px solid rgba(255,106,43,0.25)', borderRadius: 8, padding: 32, textAlign: 'center' }}>
          <p style={{ color: '#a1a1a6', marginBottom: 16, fontSize: 16 }}>هل لديك سؤال؟ نحن هنا</p>
          <a
            href="/contact"
