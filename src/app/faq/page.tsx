...
export const metadata: Metadata = {
  title: 'الأسئلة الشائعة — كل ما تريد معرفته عن SoftoDev',
  ...
  openGraph: {
    title: 'الأسئلة الشائعة — SoftoDev',
    description: 'إجابات شاملة عن الاشتراكات الرقمية في العراق.',
    url: `${BASE}/faq`,
    images: [{ url: `${BASE}/og-image.svg`, width: 1200, height: 630, alt: 'SoftoDev FAQ' }],
  },
};

const FAQS: FAQItem[] = [
  { question: 'ما هو متجر SoftoDev؟', answer: 'SoftoDev هو متجر عراقي متخصص ببيع الاشتراكات الرقمية الأصلية في العراق، مثل ChatGPT Plus، Canva Pro، CapCut Pro، Coursera Plus وأكثر. تأسس في بغداد عام 2026 ويخدم كل محافظات العراق.' },
  { question: 'هل SoftoDev متجر عراقي حقيقي؟', answer: 'نعم. SoftoDev متجر عراقي 100% مقره بغداد، وليس وسيطاً من خارج العراق. كل المعاملات تتم بالدينار العراقي والدعم باللهجة العربية العراقية.' },
  ...
  { question: 'ما هو ضمان SoftoDev؟', answer: 'كل اشتراكاتنا مضمونة طوال فترة الاشتراك. لو حدث أي مشكلة (خطأ في التفعيل، توقف الاشتراك، مشكلة في الحساب)، نعالجها مجاناً خلال ساعات. لو لم نستطع الإصلاح، نعوّضك بفترة إضافية أو استرداد كامل.' },
  ...
  { question: 'ما هي أشهر المنتجات في SoftoDev؟', answer: 'المنتجات الأكثر مبيعاً: ChatGPT Plus (للذكاء الاصطناعي)، Canva Pro (للتصميم)، CapCut Pro (لمونتاج الفيديو)، Coursera Plus (للكورسات والشهادات).' },
