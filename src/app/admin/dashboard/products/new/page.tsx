...
export default function NewProductPage() {
  ...
  async function handleSubmit(data: any) { setLoading(true); try { await adminProducts.create(data); router.push('/dashboard/products'); } catch(e){console.error(e);} finally{setLoading(false);} }
