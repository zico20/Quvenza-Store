      ...
      <div className="w-full max-w-sm">
        <div className="bg-bg-surface border border-border rounded-xl p-8 shadow-lg">
          ...
          {process.env.NODE_ENV !== 'production' && (
            <div style={{ background: 'rgba(255,106,43,0.08)', border: '1px solid rgba(255,106,43,0.2)', borderRadius: 4, padding: '10px 14px', marginBottom: 20, fontSize: 12 }}>
              <div className="mono" style={{ color: '#ff6a2b', fontSize: 10, marginBottom: 4 }}>DEV CREDENTIALS</div>
              <div style={{ color: '#a1a1a6' }}>admin@softodeviqstore.com</div>
              <div style={{ color: '#a1a1a6', fontFamily: 'JetBrains Mono, monospace' }}>Admin@2026!</div>
            </div>
          )}
