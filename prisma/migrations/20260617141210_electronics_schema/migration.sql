...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('NEW_ORDER', 'LOW_STOCK', 'NEW_CUSTOMER', 'ORDER_STATUS_CHANGED');

-- CreateEnum
CREATE TYPE "DeviceKind" AS ENUM ('PHONE', 'LAPTOP', 'TABLET', 'HEADPHONE');
...
CREATE TABLE "Product" (
    ...
    "images" TEXT[],
    "imageAlts" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "isFeatured" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "BlogPost" (
    ...
    "authorName" TEXT NOT NULL DEFAULT 'Quvenza',
    "metaTitle" VARCHAR(70),
    "metaDescription" VARCHAR(170),
...
-- CreateIndex
CREATE INDEX "Category_kind_isActive_idx" ON "Category"("kind", "isActive");
